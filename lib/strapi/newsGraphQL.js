...
const sampleNews = [
  ...
  },
  {
    ...
    "authors": ["jayasree"],
    "excerpt": "Lorem ipsum commodo sit in quis in laboris minim adipisicing laborum consequat eu. Cillum nostrud qui dolore officia occaecat ut deserunt consequat dolor non.",
...
export const fetchNewsArticle = async (newsType) => {
  let allArticles = [...sampleNews]
...
/**
 * @returns { Promise<{
 *   researchGroups: Array<{ name: string, numOfPosts: number }>
 *   collaborations: Array<{ name: string, numOfPosts: number }>
 *   projects: Array<{ name: string, numOfPosts: number }>
 *   organizations: Array<{ name: string, numOfPosts: number }>
 *   people: Array<{ name: string, numOfPosts: number }>
 * }> }
 */
