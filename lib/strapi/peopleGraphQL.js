...
export const fetchStrapiPerson = async (id) => {
  ...
  const payload = {
    ...
    researchGroup: peopleData.people.data[0].attributes.researchGroups.data[0]?.attributes ? {
      name: peopleData.people.data[0].attributes.researchGroups.data[0]?.attributes.name,
      slug: peopleData.people.data[0].attributes.researchGroups.data[0]?.attributes.slug,
    } : null,
