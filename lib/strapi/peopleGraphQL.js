...
export const fetchStrapiPerson = async (id) => {
  ...
  const payload = {
    ...
    team: peopleData.people.data[0].attributes.teams.data[0]?.attributes ? {
      name: peopleData.people.data[0].attributes.teams.data[0]?.attributes.name,
      slug: peopleData.people.data[0].attributes.teams.data[0]?.attributes.slug
    } : null,
    researchGroup: peopleData.people.data[0].attributes.research_groups.data[0]?.attributes ? {
      name: peopleData.people.data[0].attributes.research_groups.data[0]?.attributes.name,
      slug: peopleData.people.data[0].attributes.research_groups.data[0]?.attributes.slug,
    } : null,
    projects: peopleData.people.data[0].attributes.projects.data[0] ? peopleData.people.data[0].attributes.projects.data.map((project) => ({
      name: project.attributes.name,
      slug: project.attributes.project_id,
    })) : null,
    collaborations: peopleData.people.data[0].attributes.collaborations.data[0] ? peopleData.people.data[0].attributes.collaborations.data.map((project) => ({
      name: project.attributes.name,
