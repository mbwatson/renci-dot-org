...
export const fetchStrapiProject = async (id, preview = false) => {
  ...
  const payload = {
    ...
    featuredImage: projectData.projects.data[0].attributes.featuredImage.data?.attributes ? projectData.projects.data[0].attributes.featuredImage.data.attributes.url : homeHero.src,
